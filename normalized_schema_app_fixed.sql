...
CREATE TABLE IF NOT EXISTS loans (
    ...
    total_paid DECIMAL(12,2) DEFAULT 0 COMMENT 'Total terbayar',
...
-- ================================================================
-- 7. ACCOUNTING SYSTEM (SAK ETAP COMPLIANT)
-- ================================================================
...
-- ================================================================
-- 8. VIEWS FOR REPORTING & ANALYSIS
-- ================================================================
...
-- Insert sample units
INSERT INTO units (name, code, description, unit_type, is_active, created_by) VALUES
('Unit Pusat', 'UP001', 'Unit Pusat Koperasi Berjalan', 'pusat', TRUE, 1),
('Unit Jakarta', 'UP002', 'Unit Operasional Jakarta', 'unit', TRUE, 1);

-- Insert sample branches
INSERT INTO branches (unit_id, name, code, branch_type, phone, email, is_active, created_by) VALUES
(1, 'Kantor Pusat', 'KP001', 'pusat', '021-55551234', 'info@koperasi.co.id', TRUE, 1),
(1, 'Cabang Jakarta Pusat', 'CJ001', 'cabang', '021-55551235', 'jakarta@koperasi.co.id', TRUE, 1),
(2, 'Cabang Jakarta Selatan', 'CJ002', 'cabang', '021-55551236', 'jakselatan@koperasi.co.id', TRUE, 1);
