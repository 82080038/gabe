 ...
 * Minimal UI dengan fokus pada daily route
 */
...
// Get today's route data
$todayRoute = $collectorService->getDailyRoute($_SESSION['user']['id']);
$summary = $collectorService->getDailySummary();
?>
